                ...
                <div class="container-fluid">
                    <div class="clearfix">
                        ...
                        <div class="float-right">
                            <a href="<?= base_url('dashboard') ?>" class="btn btn-secondary btn-sm"><i
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('toko/proses_ubah') ?>" id="form-tambah" method="POST">
                                        <div class="form-group">
                                            <label for="nama_toko"><strong>Nama Perusahaan : </strong></label>
                                            <input type="text" name="nama_toko" id="nama_toko"
                                                value="<?= $toko->nama_toko ?>" placeholder="Masukan Nama Perusahaan"
                                                class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama_toko"><strong>Nama Pemilik Perusahaan: </strong></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="no_telepon" id="no_telepon"
                                                value="<?= $toko->no_telepon ?>" placeholder="Masukan No Telepon"
                                                class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="alamat"><strong>Alamat</strong></label>
                                            <textarea readonly name="alamat" id="alamat" class="form-control"
                                                placeholder="Masukan Alamat"
                                                style="resize: none;"><?= $toko->alamat ?></textarea>
                                        </div>
                                        <hr>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary"><i
                                                    class="fa fa-save"></i>&nbsp;&nbsp;Simpan</button>
                                            <button type="button" class="btn btn-success" id="ubah"><i
