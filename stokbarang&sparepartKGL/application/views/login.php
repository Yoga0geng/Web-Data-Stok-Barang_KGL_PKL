...
<head>
    ...
    <style>
    .bg-login-image {
        background-image: url("<?= base_url('sb-admin/img/kgl.png'); ?>");
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center mb-4">
                                        <h1 class="h4 text-gray-900">Web Stok Barang & Sparepart</h1>
                                        <span class="text-muted">PT. Karya Gemilang Labelindo</span>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="p-5">
